...
class BranchViewController: NSViewController {
	// MARK: - Variables
	...
	var Branch: NVBranch? {
		didSet {
			_textStorage.setAttributedString(NSAttributedString(string: Branch?.Condition.JavaScript ?? "ERROR"))
		}
	}
...
extension BranchViewController: NSTextViewDelegate {
	func textDidChange(_ notification: Notification) {
		Branch?.Condition.JavaScript = _codeTextbox.string
	}
}
